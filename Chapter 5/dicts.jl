# d1 = Dict(1 => 4.2, 2 => 5.3) # ok in v0.3-0.4
...
get(d3, :Z, 999) #> 999
# in( (:Z, 999), d3) #> false  #v 0.4: LoadError: Associative collections only contain Pairs;
# (:Z, 999) in d3 #> false
# in( (:A, 100), d3) #> true
# (:A, 100) in d3  #> true
...
arrn = map((i) -> dict[i], collect(1:n)) #> 1-element Array{Any,1}: 4.2